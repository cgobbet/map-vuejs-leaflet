...
features — array of objects to place markers or polygons

feature:

id: unique ID
name: name to be displayed (array)
type: In this app, features can either be markers or polygons //! where to define this
coords: lat-lng
*/
			...
			},
			{
				...
				features: [
					...
					},
					{
						...
						name: 'Canada',
						type: 'polygon',
						coords: [-140.99778, 41.6751050889, -52.6480987209, 83.23324],
					},
				],
			},
		],
